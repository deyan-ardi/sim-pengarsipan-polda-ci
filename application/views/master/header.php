...
<head>
	...
	<link href="<?= base_url() ?>assets/template/vendors/bootstrap-datepicker/dist/css/bootstrap-datepicker.css" rel="stylesheet">
	<!-- Data tables -->
						...
						<div class="left_col scroll-view">
							...
							<div class="profile clearfix">
								<div class="profile_pic">
									<img src="<?= base_url() ?>assets/upload/users/<?= $users[0]['gambar'] ?>" alt="..." class="img-circle profile_img">
								</div>
									...
									<ul class="nav side-menu">
										<?php if ($active == "1") { ?>
											...
											<?php if ($active == "2") { ?>
												...
												<li>
												<?php } ?>
												<a><i class="fa fa-edit"></i> Transaksi Surat<span class="fa fa-chevron-down"></span></a>
												...
												<?php if ($active == "3") { ?>
													...
													<li>
													<?php } ?>
													<a><i class="fa fa-print"></i> Buku Agenda <span class="fa fa-chevron-down"></span></a>
													<ul class="nav child_menu">
													...
													<?php if ($active == "8") { ?>
														...
														<li>
														<?php } ?>
														<a><i class="fa fa-external-link"></i> Referensi<span class="fa fa-chevron-down"></span></a>
														<ul class="nav child_menu">
															...
															<li><a href="<?= base_url() ?>referensi/jenis_naskah">Jenis Naskah Surat</a></li>
															<li><a href="<?= base_url() ?>referensi/klasifikasi">Klasifikasi Surat</a></li>
															<li><a href="<?= base_url() ?>referensi/arsip_surat">Kode Arsip Surat</a></li>
														</ul>
														</li>
									</ul>
								</div>
										...
										<ul class="nav side-menu">
											<?php if ($active == "4") { ?>
												...
												<?php if ($active == "5") { ?>
													...
													<li>
													<?php } ?>
													<a><i class="fa fa-files-o"></i> Data <span class="fa fa-chevron-down"></span></a>
													<ul class="nav child_menu">
							...
							<div class="sidebar-footer hidden-small">
								<a data-toggle="tooltip" data-placement="top" title="" href="<?= base_url() ?>auth/logout" data-original-title="Logout">
								...
								<ul class="nav navbar-nav navbar-right">
									<li class="">
										<a class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<img src="<?= base_url() ?>assets/upload/users/<?= $users[0]['gambar'] ?>" alt=""><?= ucfirst($_SESSION["identity"]); ?>
