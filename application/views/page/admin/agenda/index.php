	            ...
	            <div class="x_panel">
	                <div class="x_title">
	                    <form>
	                        ...
	                        <a href="<?= base_url() ?>agenda/export_all_ms" type="submit" name="xls"
	                            class="btn btn-success"><i class="fa fa-download"></i> Export All Data To Excel</a>
	                    </form>
	                ...
	                <div class="x_content">
	                    <form class="form-horizontal form-label-left" method="post"
	                        action="<?= base_url() ?>agenda/lap_surat_masuk" target="_blank">
	                        <div class="item form-group">
	                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Dari Tanggal<span
	                                    class="required">&nbsp; :</span></label>
	                            <div class="col-md-5 col-sm-5 col-xs-12">
	                                <input type="date" name="dari_tanggal" max="<?= date('Y-m-d') ?>"
	                        ...
	                        <div class="item form-group">
	                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Sampai Tanggal<span
	                                    class="required">&nbsp; :</span></label>
	                            <div class="col-md-5 col-sm-5 col-xs-12">
	                                <input type="date" name="sampai_tanggal" max="<?= date('Y-m-d') ?>"
	                        ...
	                        <div class="form-group">
	                            <div class="col-md-6 col-sm-offset-3">
	                                ...
	                                <a href="index.php?page=agd_surat_masuk" class="btn btn-warning btn-sm"><i
