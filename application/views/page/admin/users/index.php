	...
	<div class="">
		...
		<div class="">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Data users</h2>&nbsp; &nbsp;<a href="<?= base_url() ?>users/tmb_user" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah users</a>
						<a href="<?= base_url() ?>users/tmb_group" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah level</a>
							...
							<tbody>
								...
								foreach ($user as $user) : ?>
									<tr>
										...
										<td><img src="<?= base_url() ?>assets/upload/users/<?= $user->gambar ?>" alt="gambar" width="50px"></td>
										...
										<td><?php echo ($user->active) ? anchor("auth/deactivate/" . $user->id, '<button class="btn btn-success btn-sm"><i class="fa fa-check"></i> Sudah Aktif</button>') : anchor("auth/activate/" . $user->id, '<button class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Non-Aktif </button>'); ?></td>
										<td>
											<a href="<?= base_url() ?>users/edt_user/<?= $user->id ?>" class="btn btn-warning btn-sm" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
											<a href="<?= base_url() ?>users/rm_user/<?= $user->id ?>" class="btn btn-danger btn-sm" title="Hapus"><i class="fa fa-trash-o"></i></a>
									</tr>
