...
<div class="">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Data Surat Masuk</h2>&nbsp; &nbsp;<a href="<?= base_url() ?>surat/tmb_surat_masuk" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Surat Masuk</a>
						...
						<tbody>
							...
							foreach ($surat as $data) : ?>
								<tr>
									...
									<td><a href="<?= base_url() ?>assets/upload/surat_masuk/<?= $data['file'] ?>" target="blank"><?= $data['file'] ?></a></td>
									<td>
										<?php if ($group[0]['group_id'] == "1" || $group[0]['group_id'] == "3") { ?>
											<center>
												<a href="<?= base_url() ?>surat/print_surat_masuk/<?= $data['id_surat'] ?>" class="btn btn-primary" title="Print"><i class="fa fa fa-print"></i></a>
												<a href="<?= base_url() ?>surat/edit_surat_masuk/<?= $data['id_surat'] ?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
												<a href="<?= base_url() ?>surat/hapus_surat_masuk/<?= $data['id_surat'] ?>" class="btn btn-danger" title="Hapus"><i class="fa fa-trash-o"></i></a>
											</center>
										<?php } else { ?>
											<center>
												<a href="<?= base_url() ?>surat/print_surat_masuk/<?= $data['id_surat'] ?>" class="btn btn-primary" title="Print"><i class="fa fa fa-print"></i></a>
