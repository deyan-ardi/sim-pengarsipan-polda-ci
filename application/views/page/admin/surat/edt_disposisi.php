             ...
             <div class="x_panel">
                 ...
                 <div class="x_content">
                     ...
                     <form class="form-horizontal form-label-left" method="post"
                         action="<?= base_url() ?>surat/proses_edt_disposisi" enctype="multipart/form-data">
                         <div class="item form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                 <select name="no_surat" class="form-control col-md-7 col-xs-12" required="required">
                                     ...
                                     <option value="<?= $data['id_surat'] ?>" selected><?= $data['no_agenda'] ?> -
                         ...
                         <div class="item form-group">
                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Perihal<span
                                     class="required">&nbsp; :</span></label>
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" name="perihal" value="<?= $disposisi[0]['perihal'] ?>"
                         ...
                         <div class="item form-group">
                             <label class="control-label col-md-3 col-sm-3 col-xs-12">Isi Disposisi<span
                                     class="required">&nbsp;</span></label>
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" name="isi_disposisi" value="<?= $disposisi[0]['isi_disposisi'] ?>"
                                     class="form-control col-md-7 col-xs-12" required="required">
                             </div>
                         </div>
                         <div class="item form-group">
