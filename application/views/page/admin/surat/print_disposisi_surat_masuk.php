...
<div class="row" align="center">
	...
	<table cellspacing="0" cellspacing="5">
		...
		<tr>
			<td class="tgh" id="lbr" colspan="5">LEMBAR DISPOSISI SURAT MASUK</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td id="left" colspan="2"><?= $surat[0]['tanggal_surat'] ?></td>
		</tr>
		<tr>
			<td id="right" width="200"><strong> Asal Surat :</strong></td>
			<td id="left" colspan="2"><?= $surat[0]['nama_satker'] ?></td>
		</tr>
		<tr>
			<td id="right" width="200"><strong> Isi Ringkas :</strong></td>
			<td id="left" colspan="2"><?= $surat[0]['isi_ringkas']; ?></td>
		</tr>
		<tr>
			<td id="right" width="200"><strong> Diterima Tanggal :</strong></td>
			<td id="left" colspan="2"><?= $surat[0]['tanggal_terima'] ?></td>
		</tr>
	</table>
	<div id="lead">
		<p>Mengetahui,<br>
