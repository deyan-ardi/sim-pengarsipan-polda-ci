...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Data Klasifikasi Surat</h2>&nbsp; &nbsp;<a href="<?= base_url() ?>referensi/tmb_klasifikasi"
                        class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Klasifikasi Surat</a>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="<?= base_url() ?>referensi/edit_klasifikasi/<?= $data['id'] ?>"
                                            class="btn btn-warning" title="Edit"><i
                                                class="fa fa-pencil-square-o"></i></a>
                                        <a href="<?= base_url() ?>referensi/hapus_klasifikasi/<?= $data['id'] ?>"
