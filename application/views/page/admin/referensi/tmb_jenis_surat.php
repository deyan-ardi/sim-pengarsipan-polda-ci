		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form class="form-horizontal form-label-left" action="<?= base_url() ?>referensi/proses_tmb_jenis_surat" method="post">
						...
						<input type="hidden" id="id" name="id_surat" value="<?= $id_surat ?>">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left"
                        action="<?= base_url() ?>referensi/proses_tmb_jenis_surat" method="post">
                        <div class="item form-group">
