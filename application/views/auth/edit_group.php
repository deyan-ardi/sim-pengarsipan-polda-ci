					...
					<form class="form-horizontal form-label-left" action="<?= current_url() ?>" method="post">
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="group_name" name="group_name" class="form-control col-md-7 col-xs-12" required="required" value="<?= $group_name['value'] ?>">
							</div>
						</div>
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Deskripsi Level User<span class="required">&nbsp; :</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="group_description" name="group_description" class="form-control col-md-7 col-xs-12" required="required" value="<?= $group_description['value'] ?>">
							</div>
						</div>
